  ...
  return (
    <main className="p-4 max-w-screen-lg mx-auto">
      <h1 className="text-lg font-bold">
        🏖 낙원 계산기 <span className="text-sm font-medium">(목표 자산 계산하기)</span>
      </h1>
      <p className="text-sm">여러분의 낙원(경제적 자유)을 만들기 위해 얼마의 자산💰이 있어야 하는지 자산 목표를 세워보세요. 이미 당신은 낙원🏖에 한발자국👟👟 다가갔습니다.</p>
